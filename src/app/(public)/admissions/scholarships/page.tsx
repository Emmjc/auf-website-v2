        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-4 px-6 pb-16 pt-20">
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-sm text-slate-600 sm:text-base">
              This page is being prepared. Please check back soon for updated
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-16">
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm text-slate-600 sm:text-base">
            We are curating information about financial assistance, tuition
            discounts, and scholarship programs for future Angeleneans.
          </p>
        </div>
      </section>
